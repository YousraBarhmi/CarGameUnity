...
public class RoadManager : MonoBehaviour
{
    ...
    void CreateRoad()
    {
        ...
        GameObject newSideRoad = Instantiate(sideRoadPrefab, new Vector3(newRoad.transform.position.x, sideRoadPositionY, newRoad.transform.position.z + sideRoadPositionZ), Quaternion.identity);
